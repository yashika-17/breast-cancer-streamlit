...
def get_sacled_values(input_dict):
    data=get_clean_data()
...
def get_radar_chart(input_data):
    ...
    input_data=get_sacled_values(input_data)
...
# Optional: placeholder for preprocessing if needed later
def get_clean_data():
...
def add_sidebar():
    ...
    return input_dict  # Return as DataFrame
...
def main():
    ...
    with st.container():
        ...
        st.write(
            "Please connect this app to your cytology lab to help diagnose breast cancer "
            "from your tissue sample. This app predicts using a machine learning model whether "
            "a breast mass is benign or malignant based on the measurements it receives from your cytosis lab. "
